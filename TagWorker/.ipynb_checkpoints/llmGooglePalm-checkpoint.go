...
func (l *GooglePalm) Init(id string, model string) {
	l.Id = id
	l.EngineName = "Google"
	l.EngineUrl = "https://ttec-vk-dot-insightsteamsandbox.uc.r.appspot.com/api"
...
func (l *GooglePalm) LLMEngineName() string {
	return l.EngineName
}

func (l *GooglePalm) LLMEngineUrl() string {
	return l.EngineUrl
}

func (l *GooglePalm) LLMEnginePrePrompt() string {
	return l.EnginePrePrompt
}

func (l *GooglePalm) LLMEnginePostPrompt() string {
	return l.EnginePostPrompt
}

func (l *GooglePalm) LLMEngineModel() string {
	return l.Model
}

func (l *GooglePalm) Completed() bool {
	return l.IsCompleted
}

func (l *GooglePalm) Error() string {
	return l.DidError
}

func (l *GooglePalm) LLMCitations() []string {
	return l.Citations
}

func (l *GooglePalm) LLMResponse() string {
	if len(l.DidError) > 0 {
		return l.DidError
	} else {
...
func (l *GooglePalm) LLMRuntime() int64 {
	return l.Runtime
}

func (l *GooglePalm) Assign(query string, timeout int64, pre string, post string, callback WorkerCallback) {
	l.Callback = callback
	l.Query = query
...
func (l *GooglePalm) Run(wg *sync.WaitGroup) {
